    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center px-4 py-8">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-8 sm:p-10 w-full max-w-md animate-fade-in border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="relative">
              <Input
                ...
                disabled={loading}
                helperText="Minimal 6 karakter, gunakan huruf besar untuk password kuat"
              />
              <button
                type="button"
          ...
          <Button
            type="submit"
            className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] mt-6"
            loading={loading}
            disabled={loading}
          >
            {loading ? (
