...
export function PhotoViewerModal({ isOpen, onClose, photoUrl, metadata }: PhotoViewerModalProps) {
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="relative max-w-7xl max-h-[90vh] w-full">
        ...
        {/* Metadata */}
        {metadata && (
          <div className="mt-4 bg-white rounded-lg p-4 shadow-lg" onClick={(e) => e.stopPropagation()}>
